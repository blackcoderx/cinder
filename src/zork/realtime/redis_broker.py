"""Redis pub/sub broker for Zork realtime.

A drop-in replacement for :class:`~zork.realtime.broker.RealtimeBroker` that
...
Usage::
    ...
    broker = RedisBroker()
    # In app.py: self._broker = RedisBroker() when ZORK_REALTIME_BROKER=redis
"""
...
from zork.realtime.broker import Subscription

logger = logging.getLogger("zork.realtime.redis_broker")
